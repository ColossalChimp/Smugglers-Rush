	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float screenDepth70 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth70 = saturate( abs( ( screenDepth70 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) ) );
				...
				float4 fetchOpaqueVal1 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( screenUV11.xy ), 1.0 );
				...
				half3 reflectVector67 = reflect( -ase_viewDirWS, float3(dot(tanToWorld0,tanNormal67), dot(tanToWorld1,tanNormal67), dot(tanToWorld2,tanNormal67)) );
				float3 indirectSpecular67 = GlossyEnvironmentReflection( reflectVector67, 1.0 - 1.0, 1.0 );
				float2 appendResult60 = (float2(input.ase_normal.x , input.ase_normal.y));
				float3 appendResult64 = (float3(( appendResult60 - (normalMapping9).xy ) , input.ase_normal.z));
				float dotResult51 = dot( ase_viewDirWS , appendResult64 );
				...
				float screenDepth112 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth112 = abs( ( screenDepth112 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _EdgeDistance ) );
...
Node;AmplifyShaderEditor.SamplerNode;3;773.2517,-288;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;2;None;None;True;0;False;white;Auto;True;Instance;2;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;48;1951.632,-246.6161;Inherit;False;Property;_MainColor;Main Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2901959,0.470588,0.5843138,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ScreenColorNode;1;1940,-609;Inherit;False;Global;_GrabScreen0;Grab Screen 0;0;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;121;2421.081,-1818.447;Inherit;True;Property;_FoamMap;Foam Map;14;0;Create;True;0;0;0;False;0;False;-1;None;f67a16db626930547b27b4042725ab71;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;130;2835.792,-1771.536;Inherit;False;Property;_FoamColor;Foam Color;15;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5408953,0.584569,0.6132076,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=F7AD224D16370D175B6C8B61DB48A983B8843C66